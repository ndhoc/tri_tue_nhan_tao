...
class SimulationWindow(tk.Toplevel):
    def __init__(self, parent, algo_name, algo_func, starts, goals, is_belief, k, toc_do, sa_params=None, extra_params=None):
        ...
        self.extra_info = {}
        self.is_csp_algo = algo_name in ["Backtracking CSP", "Forward Checking", "AC-3", "Min-Conflicts"]
    ...
    def check_search_done(self):
        ...
        if self.search_thread.is_alive():
            ...
            if self.path is None or len(self.path) == 0:
                ...
                if self.algo_name in ["BFS Version 1", "BFS Version 2", "DFS", "IDS", "AND-OR Search", "Backtracking CSP", "Forward Checking", "AC-3", "Min-Conflicts"]:
